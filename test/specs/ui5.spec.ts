describe('UI5', () => {
    test('ui5 cart functionality', async () => {
        ...
        await page.locator('[role="listitem"][id*=category]:has-text("Keyboards")').click();
        await page.locator('[role="listitem"][id*=category]:has-text("Internet Keyboard")').click();
